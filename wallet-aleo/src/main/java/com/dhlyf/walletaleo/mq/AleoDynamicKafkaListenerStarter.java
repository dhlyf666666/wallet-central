...
@Component
public class AleoDynamicKafkaListenerStarter {
...
//            }
//        }));
        topicGroups.put(topic.getBlockNumber(), Pair.of("aleo-group", chainTopicConsumerService::Topic_BLOCK_NUMBER));
        topicGroups.put(topic.getDeposit(), Pair.of("aleo-group", depositTopicConsumerService::Topic_DEPOSIT));
        topicGroups.put(topic.getTx(), Pair.of("aleo-group", chainTopicConsumerService::Topic_TX));
