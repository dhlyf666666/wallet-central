package com.dhlyf.walletbsc.util;
...
public class EthUtil {
    ...
    public static String coolSign(EthRaw ethRaw){
        ...
        RequestData requestData = CoolWalletFormatParam.formatParma(ethRaw, Chain.BNB);
        String requestCoolWalletParam = JSONObject.toJSONString(requestData);
        log.info("requestCoolWalletParam:{}",requestCoolWalletParam);
        String coolWalletResult = HttpUtil.createPost(coolWalletUrl+"/sign/bsc")
    ...
    public static JSONObject getGastracker(){
        String body = HttpUtil.createGet(etherscanUrl + "?module=gastracker&action=gasoracle&apikey=")
