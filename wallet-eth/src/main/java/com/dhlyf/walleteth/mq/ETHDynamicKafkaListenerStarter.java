package com.dhlyf.walleteth.mq;
...
//            }
//        }));
        topicGroups.put(topic.getBlockNumber(), Pair.of("eth-group", chainTopicConsumerService::Topic_BLOCK_NUMBER));
        topicGroups.put(topic.getDeposit(), Pair.of("eth-group", depositTopicConsumerService::Topic_DEPOSIT));
        topicGroups.put(topic.getTx(), Pair.of("eth-group", chainTopicConsumerService::Topic_TX));
