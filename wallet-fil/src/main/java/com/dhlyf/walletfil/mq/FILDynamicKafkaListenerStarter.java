...
@Component
public class FILDynamicKafkaListenerStarter {
...
//            }
//        }));
        topicGroups.put(topic.getBlockNumber(), Pair.of("fil-group", chainTopicConsumerService::Topic_BLOCK_NUMBER));
        topicGroups.put(topic.getDeposit(), Pair.of("fil-group", depositTopicConsumerService::Topic_DEPOSIT));
        topicGroups.put(topic.getTx(), Pair.of("fil-group", chainTopicConsumerService::Topic_TX));
