...
import com.dhlyf.walletfil.model.fil.FilecoinCnt;
import com.dhlyf.walletfil.model.fil.Transaction;
...
public class TransactionHandler {
     ...
     */
    public static byte[] transactionSerialize(Transaction transaction) throws IOException {
        int versions = 0;
    ...
    private static byte[] WriteMajorTypeHeaderBuf(byte[] bytes, int c) {
        if (bytes[0] != 0) {
