...
@Component
public class TronDynamicKafkaListenerStarter {
...
//            }
//        }));
        topicGroups.put(topic.getBlockNumber(), Pair.of("trx-group", chainTopicConsumerService::Topic_BLOCK_NUMBER));
        topicGroups.put(topic.getDeposit(), Pair.of("trx-group", depositTopicConsumerService::Topic_DEPOSIT));
        topicGroups.put(topic.getTx(), Pair.of("trx-group", chainTopicConsumerService::Topic_TX));
